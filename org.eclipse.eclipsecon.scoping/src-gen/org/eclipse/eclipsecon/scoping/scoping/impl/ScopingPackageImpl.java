...
public class ScopingPackageImpl extends EPackageImpl implements ScopingPackage
{
   ...
   * @see org.eclipse.eclipsecon.scoping.scoping.ScopingPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static ScopingPackage init()
  {
    ...
    ScopingPackageImpl theScopingPackage = (ScopingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ScopingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ScopingPackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(packageEClass, org.eclipse.eclipsecon.scoping.scoping.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPackage_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.eclipsecon.scoping.scoping.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPackage_Imports(), this.getImport(), null, "imports", null, 0, -1, org.eclipse.eclipsecon.scoping.scoping.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPackage_Element(), this.getElement(), null, "element", null, 0, -1, org.eclipse.eclipsecon.scoping.scoping.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
