 ...
 * <ul>
 *   <li>{@link org.eclipse.eclipsecon.speaker.impl.SpeakerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpeakerImpl extends MinimalEObjectImpl.Container implements Speaker
{
  ...
  {
    return SpeakerPackage.Literals.SPEAKER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpeakerPackage.SPEAKER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpeakerPackage.SPEAKER__NAME:
        return getName();
    }
